...
public class TransferOperation extends BaseOperation {
    ...
    public byte[] toBytes() {
        ...
        byte[] extensions = this.getExtensions().toBytes();
        return Bytes.concat(feeBytes, fromBytes, toBytes, amountBytes, memoBytes, extensions);
    }

    @Override
    public String toJsonString() {
        //TODO: Evaluate using simple Gson class to return a simple string representation and drop the
        //TransferSerializer class
