...
public class DiemUniformSbSendPaymentPayload implements IDiemPayloads {

    private static final Logger LOG = Logger.getLogger(DiemUniformSbSendPaymentPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final int i,
        ...
        argsMap.put(new TypeTag.U64(), Collections.singletonList(String.valueOf(Configuration.SEND_PAYMENT_AMOUNT)));
        argsMap.put(new TypeTag.Vector(new TypeTag.U8()), Collections.singletonList(signature));

        String function = "send_payment";
        ...
        iDiemWritePayload.setEventPrefix("sendPayment ");
        iDiemWritePayload.setSpecificPayloadType("sendPayment");
