...
public class BlockData {
    ...
    public String toString() {
        ...
        sb.append(BlockData.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("jsonrpc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BlockData) == false) {
            return false;
        }
        BlockData rhs = ((BlockData) other);
