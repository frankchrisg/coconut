...
//       }
     ...
     */
    public CompletableFuture<TransactionEvent> sendTransaction(Collection<ProposalResponse> proposalResponses, User userContext, final boolean listenForTx) {
        return sendTransaction(proposalResponses, getOrderers(), userContext, listenForTx);
    }
     ...
     * @return a future allowing access to the result of the transaction invocation once complete.
     */
    public CompletableFuture<TransactionEvent> sendTransaction(Collection<? extends ProposalResponse> proposalResponses, final boolean listenForTx) {
        return sendTransaction(proposalResponses, getOrderers(), listenForTx);
    }
    ...
    public CompletableFuture<TransactionEvent> sendTransaction(Collection<? extends ProposalResponse> proposalResponses, Collection<Orderer> orderers, final boolean listenForTx) {
        return sendTransaction(proposalResponses, orderers, client.getUserContext(), listenForTx);
    }
     ...
     */
    public CompletableFuture<TransactionEvent> sendTransaction(Collection<? extends ProposalResponse> proposalResponses, Collection<Orderer> orderers, User userContext, final boolean listenForTx) {
        return sendTransaction(proposalResponses, createTransactionOptions().orderers(orderers).userContext(userContext), listenForTx);
    }
    ...
    public CompletableFuture<TransactionEvent> sendTransaction(Collection<? extends ProposalResponse> proposalResponses,
                                                               TransactionOptions transactionOptions, final boolean listenForTx) {
        return doSendTransaction(proposalResponses, transactionOptions, listenForTx)
    ...
    private CompletableFuture<TransactionEvent> doSendTransaction(Collection<? extends ProposalResponse> proposalResponses,
        ...
        try {
            ...
            if (!listenForTx || replyonly) { //If there are no eventsto complete the future, complete it
