...
import (
	...
	//"log"
	"os"
	insertionSort "github.com/hyperledger/sawtooth-sdk-go/examples/insertionSort_go/src/insertionSort/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("insertionSort-sawtooth.log",
	...
	prefix := insertionSort.Hexdigest("insertionSort")[:6]
	handler := insertionSort.NewInsertionSortHandler(prefix)
