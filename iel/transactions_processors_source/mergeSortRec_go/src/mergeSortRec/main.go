...
import (
	...
	//"log"
	"os"
	mergeSortRec "github.com/hyperledger/sawtooth-sdk-go/examples/mergeSortRec_go/src/mergeSortRec/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("mergeSortRec-sawtooth.log",
	...
	prefix := mergeSortRec.Hexdigest("mergeSortRec")[:6]
	handler := mergeSortRec.NewMergeSortRecHandler(prefix)
