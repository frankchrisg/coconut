...
import (
	...
	//"log"
	"os"
	mergeSort "github.com/hyperledger/sawtooth-sdk-go/examples/mergeSortBreadthFirst_go/src/mergeSortBreadthFirst/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("mergeSort-sawtooth.log",
	...
	prefix := mergeSort.Hexdigest("mergeSort")[:6]
	handler := mergeSort.NewMergeSortHandler(prefix)
