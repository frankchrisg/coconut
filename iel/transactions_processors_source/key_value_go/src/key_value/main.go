...
import (
	...
	//"log"
	"os"
	key_value "github.com/hyperledger/sawtooth-sdk-go/examples/key_value_go/src/key_value/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("kv-sawtooth.log",
	...
	prefix := key_value.Hexdigest("key_value")[:6]
	handler := key_value.NewKeyValueHandler(prefix)
