...
import (
	...
	//"log"
	"os"
	selectionSort "github.com/hyperledger/sawtooth-sdk-go/examples/selectionSort_go/src/selectionSort/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("selectionSort-sawtooth.log",
	...
	prefix := selectionSort.Hexdigest("selectionSort")[:6]
	handler := selectionSort.NewSelectionSortHandler(prefix)
