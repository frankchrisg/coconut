...
import (
	...
	//"log"
	"os"
	bubbleSort "github.com/hyperledger/sawtooth-sdk-go/examples/bubbleSort_go/src/bubbleSort/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("bubbleSort-sawtooth.log",
	...
	prefix := bubbleSort.Hexdigest("bubbleSort")[:6]
	handler := bubbleSort.NewBubbleSortHandler(prefix)
