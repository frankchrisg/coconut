...
import (
	...
	//"log"
	"os"
	quickSortRec "github.com/hyperledger/sawtooth-sdk-go/examples/quickSortRec_go/src/quickSortRec/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("quickSortRec-sawtooth.log",
	...
	prefix := quickSortRec.Hexdigest("quickSortRec")[:6]
	handler := quickSortRec.NewQuickSortRecHandler(prefix)
