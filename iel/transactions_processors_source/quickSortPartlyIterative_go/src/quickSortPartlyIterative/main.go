...
import (
	...
	//"log"
	"os"
	quickSortPartlyIterative "github.com/hyperledger/sawtooth-sdk-go/examples/quickSortPartlyIterative_go/src/quickSortPartlyIterative/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("quickSortPartlyIterative-sawtooth.log",
	...
	prefix := quickSortPartlyIterative.Hexdigest("quickSortPartlyIterative")[:6]
	handler := quickSortPartlyIterative.NewQuickSortPartlyIterativeHandler(prefix)
