...
import (
	...
	//"log"
	"os"
	slowSort "github.com/hyperledger/sawtooth-sdk-go/examples/slowSort_go/src/slowSort/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("slowSort-sawtooth.log",
	...
	prefix := slowSort.Hexdigest("slowSort")[:6]
	handler := slowSort.NewSlowSortHandler(prefix)
