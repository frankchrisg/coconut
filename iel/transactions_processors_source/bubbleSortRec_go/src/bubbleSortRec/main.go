...
import (
	...
	//"log"
	"os"
	bubbleSortRec "github.com/hyperledger/sawtooth-sdk-go/examples/bubbleSortRec_go/src/bubbleSortRec/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("bubbleSortRec-sawtooth.log",
	...
	prefix := bubbleSortRec.Hexdigest("bubbleSortRec")[:6]
	handler := bubbleSortRec.NewBubbleSortRecHandler(prefix)
