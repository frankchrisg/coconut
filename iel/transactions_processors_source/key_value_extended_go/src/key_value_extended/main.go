...
import (
	...
	//"log"
	"os"
	key_value_extended "github.com/hyperledger/sawtooth-sdk-go/examples/key_value_extended_go/src/key_value_extended/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("kv-extended-sawtooth.log",
	...
	prefix := key_value_extended.Hexdigest("key_value_extended")[:6]
	handler := key_value_extended.NewKeyValueExistingCheckHandler(prefix)
