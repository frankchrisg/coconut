...
import (
	...
	//"log"
	"os"
	insertionSortRec "github.com/hyperledger/sawtooth-sdk-go/examples/insertionSortRec_go/src/insertionSortRec/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("insertionSortRec-sawtooth.log",
	...
	prefix := insertionSortRec.Hexdigest("insertionSortRec")[:6]
	handler := insertionSortRec.NewInsertionSortRecHandler(prefix)
