...
import (
	...
	//"log"
	"os"
	io "github.com/hyperledger/sawtooth-sdk-go/examples/io_go/src/io/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("io-sawtooth.log",
	...
	prefix := io.Hexdigest("io")[:6]
	handler := io.NewIOHandler(prefix)
