...
import (
	...
	//"log"
	"os"
	selectionSortRec "github.com/hyperledger/sawtooth-sdk-go/examples/selectionSortRec_go/src/selectionSortRec/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("selectionSortRec-sawtooth.log",
	...
	prefix := selectionSortRec.Hexdigest("selectionSortRec")[:6]
	handler := selectionSortRec.NewSelectionSortRecHandler(prefix)
