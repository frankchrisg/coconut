...
import (
	...
	//"log"
	"os"
	recursion "github.com/hyperledger/sawtooth-sdk-go/examples/recursion_go/src/recursion/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("recursion-sawtooth.log",
	...
	prefix := recursion.Hexdigest("recursion")[:6]
	handler := recursion.NewRecursionHandler(prefix)
