...
import (
	...
	//"log"
	"os"
	static_check "github.com/hyperledger/sawtooth-sdk-go/examples/static_check_go/src/static_check/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("static-sawtooth.log",
	...
	prefix := static_check.Hexdigest("static_check")[:6]
	handler := static_check.NewStaticCheckHandler(prefix)
