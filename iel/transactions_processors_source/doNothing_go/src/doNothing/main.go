...
import (
	...
	//"log"
	"os"
	doNothing "github.com/hyperledger/sawtooth-sdk-go/examples/doNothing_go/src/doNothing/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("doNothing-sawtooth.log",
	...
	prefix := doNothing.Hexdigest("doNothing")[:6]
	handler := doNothing.NewDoNothingHandler(prefix)
