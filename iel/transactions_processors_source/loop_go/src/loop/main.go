...
import (
	...
	//"log"
	"os"
	loop "github.com/hyperledger/sawtooth-sdk-go/examples/loop_go/src/loop/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("loop-sawtooth.log",
	...
	prefix := loop.Hexdigest("loop")[:6]
	handler := loop.NewLoopHandler(prefix)
