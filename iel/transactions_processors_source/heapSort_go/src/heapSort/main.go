...
import (
	...
	//"log"
	"os"
	HeapSort "github.com/hyperledger/sawtooth-sdk-go/examples/heapSort_go/src/heapSort/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("heapSort-sawtooth.log",
	...
	prefix := HeapSort.Hexdigest("heapSort")[:6]
	handler := HeapSort.NewHeapSortHandler(prefix)
