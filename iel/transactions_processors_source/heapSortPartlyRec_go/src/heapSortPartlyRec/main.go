...
import (
	...
	//"log"
	"os"
	heapSortPartlyRec "github.com/hyperledger/sawtooth-sdk-go/examples/heapSortPartlyRec_go/src/heapSortPartlyRec/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("heapSortPartlyRec-sawtooth.log",
	...
	prefix := heapSortPartlyRec.Hexdigest("heapSortPartlyRec")[:6]
	handler := heapSortPartlyRec.NewHeapSortPartlyRecHandler(prefix)
