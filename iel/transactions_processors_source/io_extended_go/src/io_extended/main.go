...
import (
	...
	//"log"
	"os"
	io_extended "github.com/hyperledger/sawtooth-sdk-go/examples/io_extended_go/src/io_extended/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("io_extended-sawtooth.log",
	...
	prefix := io_extended.Hexdigest("io_extended")[:6]
	handler := io_extended.NewIOExtendedHandler(prefix)
