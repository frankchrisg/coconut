...
import (
	...
	//"log"
	"os"
	smallBank "github.com/hyperledger/sawtooth-sdk-go/examples/smallbank_go/src/smallbank/handler"
	"syscall"
)
...
func main() {
	...
	/*f, err := os.OpenFile("smallBank-sawtooth.log",
	...
	prefix := smallBank.Hexdigest("smallBank")[:6]
	handler := smallBank.NewSmallBankHandler(prefix)
