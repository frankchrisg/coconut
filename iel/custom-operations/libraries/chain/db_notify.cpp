...
struct get_impacted_account_visitor
{
   ...
   void operator()( const bubblesort_operation& op ) {}
   void operator()( const bubblesortRec_operation& op ) {}
   void operator()( const heapsort_operation& op ) {}
   void operator()( const heapsortPartlyRec_operation& op ) {}
   void operator()( const insertionsort_operation& op ) {}
   void operator()( const insertionsortRec_operation& op ) {}
   void operator()( const mergesortBreadthFirst_operation& op ) {}
   void operator()( const mergesortRec_operation& op ) {}
   void operator()( const quicksortPartlyIterative_operation& op ) {}
   void operator()( const quicksortRec_operation& op ) {}
   void operator()( const selectionsort_operation& op ) {}
   void operator()( const selectionsortRec_operation& op ) {}
   void operator()( const slowsort_operation& op ) {}
   void operator()( const loop_operation& op ) {}
   void operator()( const recursion_operation& op ) {}
   void operator()( const donothing_operation& op ) {}
   void operator()( const memory_operation& op ) {}
   void operator()( const static_check_operation& op ) {}
   void operator()( const key_value_in_operation& op ) {}
   void operator()( const key_value_extended_in_operation& op ) {}
   void operator()( const io_in_operation& op ) {}
   void operator()( const io_extended_in_operation& op ) {}
   void operator()( const smallbank_in_operation& op ) {}
...
void get_relevant_accounts( const object* obj, flat_set<account_id_type>& accounts, bool ignore_custom_operation_required_auths ) {
   ...
   else if( obj->id.space() == implementation_ids )
   {
      switch( (impl_object_type)obj->id.type() )
      {
			...
			case impl_bubblesort_object_type:
				 break;
			 case impl_bubblesortRec_object_type:
				 break;
			 case  impl_heapsort_object_type:
				 break;
			 case impl_heapsortPartlyRec_object_type:
				 break;
			 case impl_insertionsort_object_type:
				 break;
			 case impl_insertionsortRec_object_type:
				 break;
			 case impl_mergesortBreadthFirst_object_type:
				 break;
			 case impl_mergesortRec_object_type:
				 break;
			 case impl_quicksortPartlyIterative_object_type:
				 break;
			 case impl_quicksortRec_object_type:
				 break;
			 case impl_selectionsort_object_type:
				 break;
			 case impl_selectionsortRec_object_type:
				 break;
			 case impl_slowsort_object_type:
				 break;
			 case impl_loop_object_type:
				 break;
			 case impl_recursion_object_type:
				 break;
			 case impl_donothing_object_type:
				 break;
			 case impl_memory_object_type:
				 break;
			 case impl_static_check_object_type:
				 break;
			 case impl_key_value_in_object_type:
				 break;
			 case impl_key_value_out_object_type:
				 break;
			 case impl_key_value_extended_in_object_type:
				 break;
			 case impl_key_value_extended_out_object_type:
				 break;
			 case impl_io_in_object_type:
				 break;
			 case impl_io_out_object_type:
				 break;
			 case impl_io_extended_in_object_type:
				 break;
			 case impl_io_extended_out_object_type:
				 break;
			 case impl_smallbank_in_object_type:
				 break;
			 case impl_smallbank_out_object_type:
				 break;
			 case impl_auxiliary_event_object_type:
				 break;
