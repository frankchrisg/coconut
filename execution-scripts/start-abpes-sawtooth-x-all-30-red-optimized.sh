...
CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY_ARR=(2 10 10 10 10 10)
RATE_LIMITER_ARR=(50 50 50 50 50 100)
TX_PER_BATCH_ARR=(100 100 100 100 100 100)
...
then
CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY=${CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY_ARR[0]}
elif [ $GLOBAL_COUNTER_BS -eq 2 ]
then
CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY=${CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY_ARR[1]}
elif [ $GLOBAL_COUNTER_BS -eq 3 ]
then
CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY=${CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY_ARR[2]}
elif [ $GLOBAL_COUNTER_BS -eq 4 ]
then
CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY=${CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY_ARR[3]}
elif [ $GLOBAL_COUNTER_BS -eq 5 ]
then
CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY=${CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY_ARR[4]}
elif [ $GLOBAL_COUNTER_BS -eq 6 ]
then
CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY=${CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY_ARR[5]}
fi
echo "$CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY $GLOBAL_COUNTER_BS ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_BS-1]}" >> ~/sawtooth-opti.txt
}
...
NUMBER_OF_TRANSACTIONS_PER_BATCH_PER_CLIENT=${TX_PER_BATCH_ARR[0]}
NUMBER_OF_TRANSACTION_PAYLOADS_PER_CLIENT=${TX_PER_BATCH_ARR[0]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 2 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[1]}
NUMBER_OF_TRANSACTIONS_PER_BATCH_PER_CLIENT=${TX_PER_BATCH_ARR[1]}
NUMBER_OF_TRANSACTION_PAYLOADS_PER_CLIENT=${TX_PER_BATCH_ARR[1]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 3 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[2]}
NUMBER_OF_TRANSACTIONS_PER_BATCH_PER_CLIENT=${TX_PER_BATCH_ARR[2]}
NUMBER_OF_TRANSACTION_PAYLOADS_PER_CLIENT=${TX_PER_BATCH_ARR[2]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 4 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[3]}
NUMBER_OF_TRANSACTIONS_PER_BATCH_PER_CLIENT=${TX_PER_BATCH_ARR[3]}
NUMBER_OF_TRANSACTION_PAYLOADS_PER_CLIENT=${TX_PER_BATCH_ARR[3]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 5 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[4]}
NUMBER_OF_TRANSACTIONS_PER_BATCH_PER_CLIENT=${TX_PER_BATCH_ARR[4]}
NUMBER_OF_TRANSACTION_PAYLOADS_PER_CLIENT=${TX_PER_BATCH_ARR[4]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 6 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[5]}
NUMBER_OF_TRANSACTIONS_PER_BATCH_PER_CLIENT=${TX_PER_BATCH_ARR[5]}
NUMBER_OF_TRANSACTION_PAYLOADS_PER_CLIENT=${TX_PER_BATCH_ARR[5]}
fi
echo "$WRITE_PAYLOADS_PER_SECOND $NUMBER_OF_TRANSACTIONS_PER_BATCH_PER_CLIENT $NUMBER_OF_TRANSACTION_PAYLOADS_PER_CLIENT $GLOBAL_COUNTER_CLIENT ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_CLIENT-1]}" >> ~/sawtooth-opti.txt
}
...
handleCurrentBmBs
sed -i "s/CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY: .*/CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY: ${CONSENSUS_PBFT_BLOCK_PUBLISHING_DELAY}/g" "/home/parallels/FINAL_graphene_corda_latest_xxx/sawtooth-provisioning/vars/common-vars.yaml"
fi
