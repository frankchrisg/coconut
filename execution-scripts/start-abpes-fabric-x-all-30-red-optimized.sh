...
inputClient="$BLOCKCHAIN_BASEPATH/donothing/generalConfiguration-donothing-doNothing-40.txt,$BLOCKCHAIN_BASEPATH/donothing/fabricConfiguration-donothing-doNothing-40.txt|\
...
MAX_MESSAGES_ARR=(1000 100 100 1000 1000 1000)
...
then
MAX_MESSAGES=${MAX_MESSAGES_ARR[0]}
elif [ $GLOBAL_COUNTER_BS -eq 2 ]
then
MAX_MESSAGES=${MAX_MESSAGES_ARR[1]}
elif [ $GLOBAL_COUNTER_BS -eq 3 ]
then
MAX_MESSAGES=${MAX_MESSAGES_ARR[2]}
elif [ $GLOBAL_COUNTER_BS -eq 4 ]
then
MAX_MESSAGES=${MAX_MESSAGES_ARR[3]}
elif [ $GLOBAL_COUNTER_BS -eq 5 ]
then
MAX_MESSAGES=${MAX_MESSAGES_ARR[4]}
elif [ $GLOBAL_COUNTER_BS -eq 6 ]
then
MAX_MESSAGES=${MAX_MESSAGES_ARR[5]}
fi
echo "$MAX_MESSAGES $GLOBAL_COUNTER_BS ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_BS-1]}" >> ~/fabric-opti.txt
}
...
echo "$WRITE_PAYLOADS_PER_SECOND $GLOBAL_COUNTER_CLIENT ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_CLIENT-1]}" >> ~/fabric-opti.txt
}
...
handleCurrentBmBs
sed -i "s/MAX_MESSAGES: .*/MAX_MESSAGES: ${MAX_MESSAGES}/g" "/home/parallels/FINAL_graphene_corda_latest_xxx/fabric-provisioning/vars/common-vars.yaml"
fi
