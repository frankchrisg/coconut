...
inputClient="$BLOCKCHAIN_BASEPATH/keyvalue/generalConfiguration-keyvalue-set-40.txt,$BLOCKCHAIN_BASEPATH/keyvalue/quorumConfiguration-keyvalue-set-40.txt|\
$BLOCKCHAIN_BASEPATH/keyvalue/generalConfiguration-keyvalue-get-40.txt,$BLOCKCHAIN_BASEPATH/keyvalue/quorumConfiguration-keyvalue-get-40.txt"
...
GLOBAL_COUNTER_BMS=("KeyValue-Set" "KeyValue-Get")
ISTANBUL_BLOCKPERIOD_ARR=(5 5)
RATE_LIMITER_ARR=(100 100)
