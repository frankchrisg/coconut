...
inputClient="$BLOCKCHAIN_BASEPATH/donothing/generalConfiguration-donothing-doNothing-40.txt,$BLOCKCHAIN_BASEPATH/donothing/diemConfiguration-donothing-doNothing-40.txt|\
...
MAX_BLOCK_SIZE_ARR=(1000 2000 2000 2000 2000 2000)
RATE_LIMITER_ARR=(50 50 50 50 50 50)
...
then
MAX_BLOCK_SIZE=${MAX_BLOCK_SIZE_ARR[0]}
NUM_PREPARE_ACCOUNTS=60000
elif [ $GLOBAL_COUNTER_BS -eq 2 ]
then
MAX_BLOCK_SIZE=${MAX_BLOCK_SIZE_ARR[1]}
NUM_PREPARE_ACCOUNTS=60000
elif [ $GLOBAL_COUNTER_BS -eq 3 ]
then
MAX_BLOCK_SIZE=${MAX_BLOCK_SIZE_ARR[2]}
NUM_PREPARE_ACCOUNTS=60000
elif [ $GLOBAL_COUNTER_BS -eq 4 ]
then
MAX_BLOCK_SIZE=${MAX_BLOCK_SIZE_ARR[3]}
NUM_PREPARE_ACCOUNTS=60000
elif [ $GLOBAL_COUNTER_BS -eq 5 ]
then
MAX_BLOCK_SIZE=${MAX_BLOCK_SIZE_ARR[4]}
NUM_PREPARE_ACCOUNTS=60000
elif [ $GLOBAL_COUNTER_BS -eq 6 ]
then
MAX_BLOCK_SIZE=${MAX_BLOCK_SIZE_ARR[5]}
NUM_PREPARE_ACCOUNTS=60000
fi
echo "$MAX_BLOCK_SIZE $NUM_PREPARE_ACCOUNTS $GLOBAL_COUNTER_BS ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_BS-1]}" >> ~/diem-opti.txt
}
...
echo "$WRITE_PAYLOADS_PER_SECOND $GLOBAL_COUNTER_CLIENT ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_CLIENT-1]}" >> ~/diem-opti.txt
}
...
WAIT_FOR_NODE_PREPARATION_TIME=720s
#720s
...
handleCurrentBmBs
sed -i "s/MAX_BLOCK_SIZE: .*/MAX_BLOCK_SIZE: ${MAX_BLOCK_SIZE}/g" "/home/parallels/FINAL_graphene_corda_latest_xxx/diem-provisioning/vars/common-vars.yaml"
sed -i "s/NUM_PREPARE_ACCOUNTS: .*/NUM_PREPARE_ACCOUNTS: 60000/g" "/home/parallels/FINAL_graphene_corda_latest_xxx/diem-provisioning/vars/common-vars.yaml"
fi
