...
destinationBlockchain="/home/parallels/FINAL_graphene_corda_latest_xxx/corda-enterprise-provisioning/vars/common-vars.yaml,\
/home/parallels/FINAL_graphene_corda_latest_xxx/corda-enterprise-provisioning/hosts"

inputClient="$BLOCKCHAIN_BASEPATH/donothing/generalConfiguration-donothing-doNothing-40.txt,$BLOCKCHAIN_BASEPATH/donothing/cordaConfiguration-donothing-doNothing-40.txt|\
...
workingDirBlockchain="/home/parallels/FINAL_graphene_corda_latest_xxx/corda-enterprise-provisioning"
...
RATE_LIMITER_ARR=(20 40 5 20 5 5)
...
echo "$WRITE_PAYLOADS_PER_SECOND $GLOBAL_COUNTER_CLIENT ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_CLIENT-1]}" >> ~/corda-enterprise-opti.txt
}
