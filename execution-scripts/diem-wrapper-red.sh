...
RUNTIME=300; for x in 400; do for y in 100 500 1000 2000; do for i in {1..3}; do PREPARED_ACCOUNTS=$((RUNTIME*x*4));
...
bash start-abpes-diem-x-all-30-red.sh "hetzner-repid-$i-diem-rl-$x-bs-$y-ppa-$PREPARED_ACCOUNTS" "$x" "$y" "$PREPARED_ACCOUNTS";
