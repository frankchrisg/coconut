...
### working prev RUNTIME=300; for x in 400; do for y in 100 500 1000 2000; do for i in {1..3}; do PREPARED_ACCOUNTS=$((RUNTIME*x*4));
for i in {1..3}; do PREPARED_ACCOUNTS=25600;
...
bash start-abpes-diem-x-all-30.sh "hetzner-repid-$i-diem-rl-nenew-bs-3000-ppa-$PREPARED_ACCOUNTS" "" "3000" "$PREPARED_ACCOUNTS";
