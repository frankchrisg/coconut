...
BLOCKCHAIN_BASEPATH="/home/parallels/graphene-new-final"

inputBlockchain="$BLOCKCHAIN_BASEPATH/commonPlaybookGraphene.txt,$BLOCKCHAIN_BASEPATH/EMPTY_FILE.txt"

configurationBlockchain="$BLOCKCHAIN_BASEPATH/common-playbook-graphene.yaml,$BLOCKCHAIN_BASEPATH/hosts-graphene-4.txt"

destinationBlockchain="/home/parallels/FINAL_graphene_corda_latest_xxx/graphene-provisioning/vars/common-vars.yaml,\
/home/parallels/FINAL_graphene_corda_latest_xxx/graphene-provisioning/hosts"

inputClient="$BLOCKCHAIN_BASEPATH/bubblesort/generalConfiguration-bubblesort-sort-40.txt,$BLOCKCHAIN_BASEPATH/bubblesort/grapheneConfiguration-bubblesort-sort-40.txt|\
$BLOCKCHAIN_BASEPATH/quicksortrec/generalConfiguration-quicksortrec-sort-40.txt,$BLOCKCHAIN_BASEPATH/quicksortrec/grapheneConfiguration-quicksortrec-sort-40.txt|\
$BLOCKCHAIN_BASEPATH/donothing/generalConfiguration-donothing-doNothing-40.txt,$BLOCKCHAIN_BASEPATH/donothing/grapheneConfiguration-donothing-doNothing-40.txt|\
$BLOCKCHAIN_BASEPATH/memory/generalConfiguration-memory-memory-40.txt,$BLOCKCHAIN_BASEPATH/memory/grapheneConfiguration-memory-memory-40.txt|\
$BLOCKCHAIN_BASEPATH/keyvalue/generalConfiguration-keyvalue-set-40.txt,$BLOCKCHAIN_BASEPATH/keyvalue/grapheneConfiguration-keyvalue-set-40.txt|\
$BLOCKCHAIN_BASEPATH/keyvalue/generalConfiguration-keyvalue-get-40.txt,$BLOCKCHAIN_BASEPATH/keyvalue/grapheneConfiguration-keyvalue-get-40.txt|\
$BLOCKCHAIN_BASEPATH/io/generalConfiguration-io-write-40.txt,$BLOCKCHAIN_BASEPATH/io/grapheneConfiguration-io-write-40.txt|\
$BLOCKCHAIN_BASEPATH/io/generalConfiguration-io-scan-40.txt,$BLOCKCHAIN_BASEPATH/io/grapheneConfiguration-io-scan-40.txt|\
$BLOCKCHAIN_BASEPATH/io/generalConfiguration-io-revertScan-40.txt,$BLOCKCHAIN_BASEPATH/io/grapheneConfiguration-io-revertScan-40.txt|\
$BLOCKCHAIN_BASEPATH/sb/generalConfiguration-sb-createAccount-40.txt,$BLOCKCHAIN_BASEPATH/sb/grapheneConfiguration-sb-createAccount-40.txt|\
$BLOCKCHAIN_BASEPATH/sb/generalConfiguration-sb-writeCheck-40.txt,$BLOCKCHAIN_BASEPATH/sb/grapheneConfiguration-sb-writeCheck-40.txt|\
$BLOCKCHAIN_BASEPATH/sb/generalConfiguration-sb-depositChecking-40.txt,$BLOCKCHAIN_BASEPATH/sb/grapheneConfiguration-sb-depositChecking-40.txt|\
$BLOCKCHAIN_BASEPATH/sb/generalConfiguration-sb-transactSavings-40.txt,$BLOCKCHAIN_BASEPATH/sb/grapheneConfiguration-sb-transactSavings-40.txt|\
$BLOCKCHAIN_BASEPATH/sb/generalConfiguration-sb-sendPayment-40.txt,$BLOCKCHAIN_BASEPATH/sb/grapheneConfiguration-sb-sendPayment-40.txt|\
$BLOCKCHAIN_BASEPATH/sb/generalConfiguration-sb-balance-40.txt,$BLOCKCHAIN_BASEPATH/sb/grapheneConfiguration-sb-balance-40.txt|\
$BLOCKCHAIN_BASEPATH/sb/generalConfiguration-sb-amalgamate-40.txt,$BLOCKCHAIN_BASEPATH/sb/grapheneConfiguration-sb-amalgamate-40.txt"

configurationClient="$BLOCKCHAIN_BASEPATH/generalConfiguration.properties,$BLOCKCHAIN_BASEPATH/grapheneConfiguration.properties|\
$BLOCKCHAIN_BASEPATH/generalConfiguration.properties,$BLOCKCHAIN_BASEPATH/grapheneConfiguration.properties|\
$BLOCKCHAIN_BASEPATH/generalConfiguration.properties,$BLOCKCHAIN_BASEPATH/grapheneConfiguration.properties|\
$BLOCKCHAIN_BASEPATH/generalConfiguration.properties,$BLOCKCHAIN_BASEPATH/grapheneConfiguration.properties|\
$BLOCKCHAIN_BASEPATH/generalConfiguration.properties,$BLOCKCHAIN_BASEPATH/grapheneConfiguration.properties|\
$BLOCKCHAIN_BASEPATH/generalConfiguration.properties,$BLOCKCHAIN_BASEPATH/grapheneConfiguration.properties|\
...
destinationClient="/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/generalConfiguration.properties,/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/grapheneConfiguration.properties|\
/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/generalConfiguration.properties,/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/grapheneConfiguration.properties|\
/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/generalConfiguration.properties,/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/grapheneConfiguration.properties|\
/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/generalConfiguration.properties,/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/grapheneConfiguration.properties|\
/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/generalConfiguration.properties,/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/grapheneConfiguration.properties|\
/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/generalConfiguration.properties,/home/parallels/FINAL_graphene_corda_latest_xxx/client/templates/client_skel/configs/grapheneConfiguration.properties|\
...
inputClientProv="$BLOCKCHAIN_BASEPATH/clientCommonPlaybookCommongraphene.txt,$BLOCKCHAIN_BASEPATH/clientPlaybookgraphene.txt|\
$BLOCKCHAIN_BASEPATH/clientCommonPlaybookCommongraphene.txt,$BLOCKCHAIN_BASEPATH/clientPlaybookgraphene.txt|\
$BLOCKCHAIN_BASEPATH/clientCommonPlaybookCommongraphene.txt,$BLOCKCHAIN_BASEPATH/clientPlaybookgraphene.txt|\
$BLOCKCHAIN_BASEPATH/clientCommonPlaybookCommongraphene.txt,$BLOCKCHAIN_BASEPATH/clientPlaybookgraphene.txt|\
$BLOCKCHAIN_BASEPATH/clientCommonPlaybookCommongraphene.txt,$BLOCKCHAIN_BASEPATH/clientPlaybookgraphene.txt|\
$BLOCKCHAIN_BASEPATH/clientCommonPlaybookCommongraphene.txt,$BLOCKCHAIN_BASEPATH/clientPlaybookgraphene.txt|\
...
workingDirBlockchain="/home/parallels/FINAL_graphene_corda_latest_xxx/graphene-provisioning"
...
BLOCK_INTERVAL=$3
NUMBER_OF_OPERATIONS_PER_TRANSACTION=$4
...
iterateOverBlockchainConfigurationFiles() {
  ...
  for value in "${!inputBlockchainArr[@]}"; do
	...
	if [ -z ${BLOCK_INTERVAL} ];
    then
        echo "Not replacing block interval..."
    else
        sed -i "s/BLOCK_INTERVAL: .*/BLOCK_INTERVAL: ${BLOCK_INTERVAL}/g" "${destinationBlockchainArr[value]}"
    fi
...
iterateOverClientConfigurationFiles() {
  ...
  for value in "${!inputClientArr[@]}"; do
	...
	if [ -z ${NUMBER_OF_OPERATIONS_PER_TRANSACTION} ];
    then
        echo "Not replacing operations per transaction..."
    else
        sed -i "s/NUMBER_OF_OPERATIONS_PER_TRANSACTION=.*/NUMBER_OF_OPERATIONS_PER_TRANSACTION=${NUMBER_OF_OPERATIONS_PER_TRANSACTION}/g" "${destinationClientArr[value]}"
    fi
	
	if [ -z ${NUMBER_OF_TRANSACTIONS_PER_CLIENT} ];
    then
        echo "Not replacing number of transactions per client..."
    else
        sed -i "s/NUMBER_OF_TRANSACTIONS_PER_CLIENT=.*/NUMBER_OF_TRANSACTIONS_PER_CLIENT=${NUMBER_OF_TRANSACTIONS_PER_CLIENT}/g" "${destinationClientArr[value]}"
    fi
