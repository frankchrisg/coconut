...
inputClient="$BLOCKCHAIN_BASEPATH/donothing/generalConfiguration-donothing-doNothing-40.txt,$BLOCKCHAIN_BASEPATH/donothing/grapheneConfiguration-donothing-doNothing-40.txt|\
...
BLOCK_INTERVAL_ARR=(1 5 5 2 2 2)
RATE_LIMITER_ARR=(400 400 400 400 400 400)
NUMBER_OF_OPERATIONS_ARR=(100 50 50 50 100 100)
...
then
BLOCK_INTERVAL=${BLOCK_INTERVAL_ARR[0]}
elif [ $GLOBAL_COUNTER_BS -eq 2 ]
then
BLOCK_INTERVAL=${BLOCK_INTERVAL_ARR[1]}
elif [ $GLOBAL_COUNTER_BS -eq 3 ]
then
BLOCK_INTERVAL=${BLOCK_INTERVAL_ARR[2]}
elif [ $GLOBAL_COUNTER_BS -eq 4 ]
then
BLOCK_INTERVAL=${BLOCK_INTERVAL_ARR[3]}
elif [ $GLOBAL_COUNTER_BS -eq 5 ]
then
BLOCK_INTERVAL=${BLOCK_INTERVAL_ARR[4]}
elif [ $GLOBAL_COUNTER_BS -eq 6 ]
then
BLOCK_INTERVAL=${BLOCK_INTERVAL_ARR[5]}
fi
echo "$BLOCK_INTERVAL $GLOBAL_COUNTER_BS ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_BS-1]}" >> ~/graphene-opti.txt
}
...
NUMBER_OF_OPERATIONS_PER_TRANSACTION=${NUMBER_OF_OPERATIONS_ARR[0]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 2 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[1]}
NUMBER_OF_OPERATIONS_PER_TRANSACTION=${NUMBER_OF_OPERATIONS_ARR[1]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 3 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[2]}
NUMBER_OF_OPERATIONS_PER_TRANSACTION=${NUMBER_OF_OPERATIONS_ARR[2]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 4 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[3]}
NUMBER_OF_OPERATIONS_PER_TRANSACTION=${NUMBER_OF_OPERATIONS_ARR[3]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 5 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[4]}
NUMBER_OF_OPERATIONS_PER_TRANSACTION=${NUMBER_OF_OPERATIONS_ARR[4]}
elif [ $GLOBAL_COUNTER_CLIENT -eq 6 ]
then
WRITE_PAYLOADS_PER_SECOND=${RATE_LIMITER_ARR[5]}
NUMBER_OF_OPERATIONS_PER_TRANSACTION=${NUMBER_OF_OPERATIONS_ARR[5]}
fi
echo "$WRITE_PAYLOADS_PER_SECOND $NUMBER_OF_OPERATIONS_PER_TRANSACTION $GLOBAL_COUNTER_CLIENT ${GLOBAL_COUNTER_BMS[$GLOBAL_COUNTER_CLIENT-1]}" >> ~/graphene-opti.txt
}
...
handleCurrentBmBs
sed -i "s/BLOCK_INTERVAL: .*/BLOCK_INTERVAL: ${BLOCK_INTERVAL}/g" "/home/parallels/FINAL_graphene_corda_latest_xxx/graphene-provisioning/vars/common-vars.yaml"
fi
