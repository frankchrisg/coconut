...
allBlocksRep <- allBlocksRep[allBlocksRep$run_id != "4000000-sawtoothConfiguration-keyvalue-set-40-flalv-rn-1-hetzner-repid-0-sawtooth-rl-400-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-2",]
allBlocksRep <- allBlocksRep[allBlocksRep$run_id != "4000000-sawtoothConfiguration-sb-sendPayment-40-flalv-rn-1-hetzner-repid-0-sawtooth-rl-200-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-1",]
allBlocksRep <- allBlocksRep[allBlocksRep$run_id != "4000000-sawtoothConfiguration-sb-sendPayment-40-flalv-rn-1-hetzner-repid-0-sawtooth-rl-200-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-10",]
allBlocksRep <- allBlocksRep[allBlocksRep$run_id != "4000000-sawtoothConfiguration-sb-createAccount-40-flalv-rn-1-hetzner-repid-0-sawtooth-rl-200-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-1",]
allBlocksRep <- allBlocksRep[allBlocksRep$run_id != "4000000-sawtoothConfiguration-sb-createAccount-40-flalv-rn-1-hetzner-repid-0-sawtooth-rl-200-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-10",]
bs <- c()
bm <- c()
bmf <- c()
...
allBlocks$cutCriteria <-
  str_split_fixed(allBlocks$run_id, "-", Inf)[, 24]
...
allBlocksRepCid <- allBlocksRepCid[!(allBlocksRepCid$run_id %like% "4000000-sawtoothConfiguration-keyvalue-set-40-flalv-rn-1-hetzner-repid-.*-sawtooth-rl-400-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-2"),]
allBlocksRepCid <- allBlocksRepCid[!(allBlocksRepCid$run_id %like% "4000000-sawtoothConfiguration-sb-sendPayment-40-flalv-rn-1-hetzner-repid-.*-sawtooth-rl-200-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-1"),]
allBlocksRepCid <- allBlocksRepCid[!(allBlocksRepCid$run_id %like% "4000000-sawtoothConfiguration-sb-sendPayment-40-flalv-rn-1-hetzner-repid-.*-sawtooth-rl-200-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-10"),]
allBlocksRepCid <- allBlocksRepCid[!(allBlocksRepCid$run_id %like% "4000000-sawtoothConfiguration-sb-createAccount-40-flalv-rn-1-hetzner-repid-.*-sawtooth-rl-200-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-1"),]
allBlocksRepCid <- allBlocksRepCid[!(allBlocksRepCid$run_id %like% "4000000-sawtoothConfiguration-sb-createAccount-40-flalv-rn-1-hetzner-repid-.*-sawtooth-rl-200-notpbpc-100-nobpc-1-maxbtperbl-100000-notppc-100-cpbftbpd-10"),]
bs <- c()
bm <- c()
bmf <- c()
...
allBlocksCid$cutCriteria <-
  str_split_fixed(allBlocksCid$run_id, "-", Inf)[, 24]
...
for (benchmark in benchmarkList) {
  ...
  preparedDataFrame <- subset(preparedDataFrame, Category != "PD=2s" & Category != "PD=5s")
