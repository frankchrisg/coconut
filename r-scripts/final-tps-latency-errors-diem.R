...
save <- function(titleVar, plot, path) {
  fileName = tolower(gsub(
    " ",
    "",
    paste("C:/Users/frank/Downloads/final-plots/diem/",path,"/", titleVar, ".png"),
    fixed = TRUE
  ))
  ggsave(
    fileName,
...
fNameFullAll <-
  "C:/Users/frank/Downloads/testwr-diem"
...
longFormatLatencyBak <- datalistLatency[[3]] #longFormatLatency
longFormatLatencyBak$RL <- apply(longFormatLatencyBak, 1, function(x) gsub("RL=", " ", x[["RL"]], fixed = TRUE))
longFormatLatencyBak$SDLATENCY <- round(longFormatLatencyBak$SDLATENCY, digits = 2)
longFormatLatencyBak$value <- round(longFormatLatencyBak$value, digits = 2)
...
longFormatTpsBak <- datalistTps[[3]] #longFormatTps
longFormatTpsBak$RL <- apply(longFormatTpsBak, 1, function(x) gsub("RL=", " ", x[["RL"]], fixed = TRUE))
...
longFormatAllDataRowsBak <- datalistFailures[[3]] #longFormatAllDataRows
longFormatAllDataRowsBak$RL <- apply(longFormatAllDataRowsBak, 1, function(x) gsub("RL=", " ", x[["RL"]], fixed = TRUE))
longFormatAllDataRowsBak <- longFormatAllDataRowsBak[,-3]
...
x1 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "donothing" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==1000,]$stf
x2 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "donothing" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==1000,]$etf

x3 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "set" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==1000,]$stf
x4 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "set" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==1000,]$etf

x5 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "get" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==2000,]$stf
x6 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "get" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==2000,]$etf

x7 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "create" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==2000,]$stf
x8 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "create" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==2000,]$etf

x9 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "send" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==2000,]$stf
x10 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "send" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==2000,]$etf

x11 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "balance" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==2000,]$stf
x12 <- tpsAndLatencyData[tpsAndLatencyData$run_id %like% "balance" & tpsAndLatencyData$rl==50 & tpsAndLatencyData$cutCriteria==2000,]$etf
...
write.csv(dfw, "C:/Users/frank/Downloads/diemFnh.csv", row.names=FALSE)