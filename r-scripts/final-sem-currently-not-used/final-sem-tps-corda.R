...
save <- function(titleVar, plot) {
  fileName = tolower(gsub(
    " ",
    "",
    #paste("C:/Users/parallels/Downloads/final-plots/sem-tps-cordaos/", titleVar, ".png"),
    paste("C:/Users/parallels/Downloads/final-plots/sem-tps-cordaenterprise/", titleVar, ".png"),
    fixed = TRUE
  ))
  ggsave(
    fileName,
