...
basicSystem <-
  read.table('C:/Users/parallels/Downloads/quorum.txt',
             sep = '&',
             comment.char = '\\')
basicSystem$bs <- "Quorum"
...
save <- function(titleVar, plot) {
  fileName = tolower(gsub(
    " ",
    "",
    paste("C:/Users/parallels/Downloads/final-plots/sem-blocks-quorum-single/", titleVar, ".png"),
    fixed = TRUE
  ))
  ggsave(
    fileName,
