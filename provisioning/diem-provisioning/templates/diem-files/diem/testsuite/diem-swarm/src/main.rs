...
fn main() {
    ...
    let mut builder = LocalSwarm::builder(Arc::new(versions)).node_args(args.node_args).number_of_validators(args.num_nodes)
    .node_paths(args.node_paths).num_prepare_accounts(args.num_prepare_accounts);
